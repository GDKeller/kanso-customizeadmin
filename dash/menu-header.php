 ...
 */
function kanso_wp_menu_output( $menu, $submenu, $submenu_as_parent = true ) {
	...
	<div id="adminmenuwrap">
		<div class="userinfo" style="color:white;text-align:center;">
			<?php
				...
				echo '<h2 class="name">' . $current_user->user_login . '</h2>' ;
				echo '<p class="time">' . date( 'h:i A', current_time( 'timestamp' ) . "</p>" );
